 ...
 * @author vip comp
 */
public class LoggedUserBuilder implements UserBuilder {
    ...
    @Override
    public User build() {
        return new User(userID, email, username, password, dateOfBirth, status, bio, profilePhoto, coverPhoto, profilePhotoPath, coverPhotoPath, contents, friends, blockedUsers, incomingRequests, sentRequests);
    }
