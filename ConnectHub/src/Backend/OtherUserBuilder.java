 ...
 * @author vip comp
 */
public class OtherUserBuilder implements UserBuilder {
    ...
    @Override
    public User build() {
        return new User(userID, null, username, null, dateOfBirth, null, bio, profilePhoto, coverPhoto, profilePhotoPath, coverPhotoPath, null, friends, blockedUsers, incomingRequests, sentRequests);
    }
